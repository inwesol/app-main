import { pgTable, foreignKey, uuid, timestamp, text, boolean, unique, varchar, json, integer, serial, jsonb, numeric, uniqueIndex, index, primaryKey } from "drizzle-orm/pg-core"
...
export const careerStoryFours = pgTable("career_story_fours", {
	id: uuid().defaultRandom().primaryKey().notNull(),
