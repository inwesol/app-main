...
export function PostCareerMaturity({ sessionId }: { sessionId: string }) {
  ...
  useEffect(() => {
    setQuestionnaireBreadcrumbs(sessionId, "Career Maturity Assessment-2");
  ...
  useEffect(() => {
    async function fetchData() {
      const qId = "post-career-maturity";
      setIsLoading(true);
      try {
          ...
          <div className="p-5 mb-6 border shadow-lg bg-gradient-to-br from-primary-blue-50 via-white to-primary-green-50 rounded-2xl sm:p-6 border-slate-200/60 backdrop-blur-sm">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-base leading-relaxed text-slate-700">
                ...
                statements are about your current thoughts, attitudes, and
