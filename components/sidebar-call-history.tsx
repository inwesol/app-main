...
const dummyCalls: Call[] = [
  ...
  },
  {
    ...
    visibility: "public",
    summary:
      "Meeting was missed due to scheduling conflict. Rescheduled for tomorrow.",
    transcription: [],
  },
  {
    id: "4",
  ...
  },
  {
    ...
    visibility: "public",
    summary:
      "Monthly all-hands meeting. Topics covered:\n- Company performance review\n- New hire introductions\n- Product roadmap updates\n- Customer success stories\n- Team building activities",
    transcription: [
      {
...
export function SidebarCallHistory({ user }: { user: User | undefined }) {
  // Removed useSidebar - not needed for this component
  const { id } = useParams();
  const setOpenMobile = () => {}; // No-op function for compatibility
