...
export function SimpleViewDialog({
  isOpen,
  onClose,
  contentOnly,
}: SimpleViewDialogProps) {
  ...
  const cardContent = (
    ...
    >
      ...
      <CardContent
        id="journey-insights-content"
        className="space-y-8 overflow-y-auto max-h-[calc(90vh-120px)]"
      >
        {isLoading ? (
            ...
            <div>
              ...
              !prosCons.cons.behaviour ? (
                <div className="py-6 text-center text-slate-500 bg-slate-50 rounded-lg border border-slate-200">
                  ...
                  <p className="mt-1 text-xs text-slate-400">
                    Complete the life collage activity to add your pros & cons.
                  </p>
                </div>
              ) : (
