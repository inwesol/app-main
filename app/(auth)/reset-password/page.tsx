    ...
    <Suspense
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-white px-4 sm:px-6">
          <div className="max-w-md w-full bg-white rounded-xl shadow-[4px_4px_10px_rgba(0,0,0,0.1),-4px_4px_10px_rgba(0,0,0,0.1),0_-4px_10px_rgba(0,0,0,0.1)] p-6 sm:p-8">
