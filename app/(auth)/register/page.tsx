...
export default function Page() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden lg:flex w-full lg:w-2/3 relative overflow-hidden">
      ...
      <div className="flex w-full lg:w-1/3 relative items-center justify-center min-h-screen">
        {/* Background Effects */}
        ...
        <div className=" mx-auto px-12">
          <div className="backdrop-blur-xl bg-white/95 rounded-3xl shadow-lg border border-white/30 p-4 relative overflow-hidden">
            <div className="text-center mb-4 relative">
              ...
              <p className="text-gray-600 text-lg">Create your new Account</p>
            </div>
            ...
            {showPlaceholder && (
              <div className="space-y-3 animate-pulse px-4 py-3">
                ...
                <div className="h-2 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl" />
                <div className="h-12 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl" />
              </div>
            )}
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="text-center pt-4 border-t border-gray-100">
                    ...
                    <p className="block text-xs text-gray-400 mt-3">
